...
public class SupplyStation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player.GetComponentInChildren<SuppliesAvailable>() != null)
        {
            player.GetComponentInChildren<SuppliesAvailable>().menuAvailable = menuAvailable;
            player.GetComponentInChildren<SuppliesAvailable>().closeNow = closeNow;
        }
    }
